...
/*   Updated: 2024/11/06 17:27:29 by junsan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	check_and_store_elements(\
				t_description_file *desc_file, char **elements)
{
...
bool	parse(t_description_file *desc_file, char **argv)
{
	...
	if (!check_and_store_elements(desc_file, elements))
	{
		...
		return (clean_elements_array(elements), \
		close(desc_file->fd), clean_all(desc_file), false);
	}
